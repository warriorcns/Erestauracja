...
namespace Contract {
    ...
    internal class Queries {
        ...
        /// <summary>
        ///   Looks up a localized string similar to SELECT r.`id` FROM `restaurants` r JOIN `users` u ON r.`userId`=u.`id` WHERE u.`email` = @email.
        /// </summary>
        internal static string GetRestaurantIdByEmail {
            get {
                return ResourceManager.GetString("GetRestaurantIdByEmail", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   Looks up a localized string similar to UPDATE `users` SET `email`=@email WHERE `id` = (SELECT `userId` FROM `restaurants` WHERE `id` =@id).
        /// </summary>
        internal static string UpdateRestaurantEmail {
            get {
                return ResourceManager.GetString("UpdateRestaurantEmail", resourceCulture);
            }
        }
