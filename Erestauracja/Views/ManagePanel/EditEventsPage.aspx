<%@ Page Title="" Language="C#" MasterPageFile="~/Views/ManagePanel/ManagePageContent.master" Inherits="System.Web.Mvc.ViewPage<Erestauracja.Models.EventsPageModel>" %>
...
<fieldset>
    <legend>Imprezy okolocznościowe - edycja</legend>
<asp:Panel ID="Panel5" class="PanelDowoz" runat="server" ScrollBars="Auto">
       
                <%: Html.TextAreaFor(m => m.Events, new { id = "htmlarea", style = "width: 800px", rows = "19" })%>
